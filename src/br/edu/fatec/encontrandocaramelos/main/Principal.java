...
public class Principal {
	public static void main(String[] args) {
		...
		System.out.println("--------------------------------------------------\n1-Sou Ong| 2- Sou Adotante | 3-Sair\n--------------------------------------------------");
		...
		while (escolha != 3) {
			...
			case 1:
				...
				// MENU DA ONG
				System.out.println("----------------------------------------------------------------------------------------------------\n1-Cadastar pet | 2-Atualizar pet | 3-Listar pets | 4-Excluir pet | 5-Sair\n----------------------------------------------------------------------------------------------------");
				...
				while (opcoesOng != 5) {
					...
					// ATUALIZAR PET
					// SÓ ESTÃO DISPONÍVEIS ALGUNS CAMPOS DO PET PARA ATUALIZAR PET.
					case 2:
						ong.showPet();
